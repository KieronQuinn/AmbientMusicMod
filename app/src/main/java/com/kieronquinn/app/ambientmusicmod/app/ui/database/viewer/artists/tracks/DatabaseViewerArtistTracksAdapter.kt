...
class DatabaseViewerArtistTracksAdapter(private val context: Context, var tracks: List<Track>): RecyclerView.Adapter<DatabaseViewerArtistTracksAdapter.ViewHolder>(), FastScrollRecyclerView.SectionedAdapter {
