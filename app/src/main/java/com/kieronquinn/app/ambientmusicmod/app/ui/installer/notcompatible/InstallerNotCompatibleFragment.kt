...
import com.kieronquinn.app.ambientmusicmod.databinding.FragmentInstallerNotCompatibleBinding
import com.kieronquinn.app.ambientmusicmod.utils.extensions.getText

class InstallerNotCompatibleFragment: BaseFragment<FragmentInstallerNotCompatibleBinding>(FragmentInstallerNotCompatibleBinding::class) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(navArguments.compatibilityStatus){
            ...
            binding.installerNotCompatibleSoundModel.isVisible = getModelSupported != AmbientSharedPreferences.GetModelSupported.SUPPORTED
